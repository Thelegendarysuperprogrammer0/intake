...
class AfspraakController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('IntakeBundle:afspraak:index.html.twig', array(
            'afspraaks' => $afspraaks,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('IntakeBundle:afspraak:new.html.twig', array(
            'afspraak' => $afspraak,
    ...
    public function showAction(Afspraak $afspraak)
    {
        ...
        return $this->render('IntakeBundle:afspraak:show.html.twig', array(
            'afspraak' => $afspraak,
    ...
    public function editAction(Request $request, Afspraak $afspraak)
    {
        ...
        return $this->render('IntakeBundle:afspraak:edit.html.twig', array(
            'afspraak' => $afspraak,
