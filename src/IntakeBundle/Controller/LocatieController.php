...
class LocatieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('IntakeBundle:locatie:index.html.twig', array(
            'locaties' => $locaties,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('IntakeBundle:locatie:new.html.twig', array(
            'locatie' => $locatie,
    ...
    public function showAction(Locatie $locatie)
    {
        ...
        return $this->render('IntakeBundle:locatie:show.html.twig', array(
            'locatie' => $locatie,
    ...
    public function editAction(Request $request, Locatie $locatie)
    {
        ...
        return $this->render('IntakeBundle:locatie:edit.html.twig', array(
            'locatie' => $locatie,
