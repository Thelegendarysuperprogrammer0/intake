...
class AfdelingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('IntakeBundle:afdeling:index.html.twig', array(
            'afdelings' => $afdelings,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('IntakeBundle:afdeling:new.html.twig', array(
            'afdeling' => $afdeling,
    ...
    public function showAction(Afdeling $afdeling)
    {
        ...
        return $this->render('IntakeBundle:afdeling:show.html.twig', array(
            'afdeling' => $afdeling,
    ...
    public function editAction(Request $request, Afdeling $afdeling)
    {
        ...
        return $this->render('IntakeBundle:afdeling:edit.html.twig', array(
            'afdeling' => $afdeling,
